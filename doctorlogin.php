...
<body>
    ...
    <button class="btn"><a href="doctorforgetpassword.php">Forget Password</a></button>
        <div class="container">

            <h2 style="color: red;"> Login For Doctor </h2>
              <form action="doctorloginverify.php" method="post">
               ...
               <input type="submit" name="doctor_login" value="Login"></input>
        <br><br>
