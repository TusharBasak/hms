...
<body>
    ...
    <button class="btn"><a href="patientforgetpassword.php">Forget Password</a></button>
        <div class="container">

            <h2 style="color: red;"> Login For Patient </h2>
              <form action="patientloginverify.php" method="post">
               ...
               <input type="submit" name="patient_login" value="Login"></input>
        <br><br>
