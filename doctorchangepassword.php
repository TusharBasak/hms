...
if(isset($_POST['forget_password'])){
 ...
 if(!$result1){
  ...
  if(!$flag){
    header('location:doctorforgetpassword.php?message1=Your email is not found!!');
  }

  if(strlen($password)<6){
    header('location:doctorforgetpassword.php?message1=Your password must contain atleast 6 charecters');
    $flag=false;
  ...
  if($flag){
    ...
    header('location:doctorforgetpassword.php?message1=Your Password Change Successfully....');
    }
  }
//   else{
